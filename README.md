...
Extra Step
Like to add one more step is you are using a different camera for frame capturing If you want to use mobile camera then download app "IP webcam" from playstore and copy IP (provided in the app ) paste the IP in the main.py as I have stated in the main.py file. And run the camera_test.py and camera_test2.py file to see the working
...
6️⃣ Output CSV File
You will see this file in the working folder Example:
